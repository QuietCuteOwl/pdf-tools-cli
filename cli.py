...
@main.command()
@click.argument('input_pdf')
@click.option('-o', '--output', 'output_dir', required=False, help="Output Directory")
...
@click.argument('target_pdf', type=click.Path(exists=True))
...
@main.command()
@click.argument('input_pdf', type=click.Path(exists=True))
@click.argument('watermark_pdf', type=click.Path(exists=True))
@click.option('-o', '--output', 'output_dir', required=False, default='.', help="Output Directory")
